...
- Использовала хранилище Redux для управления состоянием и хранения данных
- Для оптимизации загрузки и работы с сетью использовала lazy и компонент Suspense
- Для обработки ошибок использовала компонент ErrorBoundary, базовую валидацию инпута до отправки запроса, и catch, если вернется ошибка
